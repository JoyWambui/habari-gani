...
class ArticleTest(unittest.TestCase):
    ...
    def test_correct_instantiation(self):
        ...
        self.assertEqual(self.new_article.article_title,"fuel prices continue to soar")
        self.assertEqual(self.new_article.article_description,"Fuel prices will continue on an upward trajectory")
